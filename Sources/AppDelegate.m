...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
  ...
  if(settingsBundle) {
    ...
    for(NSDictionary *prefSpecification in preferences) {
      ...
      if (key)
      {
        ...
        id currentObject = [standardDefaults objectForKey:key];
  ...
  UINavigationController *viewController = [[UINavigationController alloc] initWithRootViewController:homeController];
