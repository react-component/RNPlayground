...
/**
 *  判断框架脚本是否已经就绪
 *  @author AntRectNative
 */
@property (nonatomic, assign) BOOL isReady;

/**
 *  判断当前Bridge所在的ViewController是否是用户当前使用的，by wenhong.cwh
 *  @author AntRectNative
 */
 ...
 *  @author AntReactNative
 */
- (void)loadAppSource:(NSURL *)appBundleURL;
...
- (void)executeJavaScript:(NSString *)javaScript
               onComplete:(RCTJavaScriptCallback)onComplete;
@end
